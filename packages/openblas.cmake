macro(build_openblas)
  ...
  list(APPEND TRILINOS_CONFOPTS "-D TPL_BLAS_LIBRARIES:STRING=${OpenBLAS_DIR}/lib64")
  list(APPEND TRILINOS_CONFOPTS "-D TPL_LAPACK_LIBRARIES:STRING=${OpenBLAS_DIR}/lib64")
