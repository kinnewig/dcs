macro(build_openblas)
  ...
  list(APPEND TRILINOS_CONFOPTS "-D TPL_BLAS_LIBRARIES:STRING=${BLAS_LIBS}")
  list(APPEND TRILINOS_CONFOPTS "-D TPL_LAPACK_LIBRARIES:STRING=${LAPACK_LIBS}")

  # Configure MUMPS to use OpenBLAS
  list(APPEND MUMPS_DEPENDENCIES "OpenBLAS")
  list(APPEND MUMPS_CONFOPTS "-D pc_blas_LIBRARY_DIRS=${BLAS_DIR}/lib")
  list(APPEND MUMPS_CONFOPTS "-D pc_lapack_LIBRARY_DIRS=${BLAS_DIR}/lib")

  # Configure ScaLAPACK to use OpenBLAS
  list(APPEND SCALAPACK_DEPENDENCIES "OpenBLAS")
  list(APPEND SCALAPACK_CONFOPTS "-D pc_blas_LIBRARY_DIRS=${BLAS_DIR}/lib")
  list(APPEND SCALAPACK_CONFOPTS "-D pc_lapack_LIBRARY_DIRS=${BLAS_DIR}/lib")
